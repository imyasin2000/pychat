...
class Window(QMainWindow):
    ...
    def __init__(self):
        ...
        self.send_b_11.setStyleSheet("background-color: light gray;border: 0px solid white;border-radius:20px;") 
    ...
    def file_receve(self):
        ...
        self.messege_user.setIcon(QIcon(os.path.abspath(os.getcwd()+'/icons/download.png')))
        ...
        self.id.setStyleSheet("background-color: transparent;border: 0px none;border-radius: 10px;font-size: 1px;") 
